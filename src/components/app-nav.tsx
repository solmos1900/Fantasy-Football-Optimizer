...
export function AppNav({ league = null }: { league?: AppNavLeague | null }) {
  ...
  return (
    <>
      ...
      */}
      <header className="sticky top-0 z-40 border-b-[1.5px] border-emerald-950/12 bg-[color-mix(in_srgb,var(--surface)_88%,var(--kraft))]/95 shadow-[0_1px_0_color-mix(in_srgb,var(--surface)_70%,transparent)_inset,0_8px_24px_-18px_rgba(27,48,34,0.35)] backdrop-blur-md pt-[env(safe-area-inset-top,0px)]">
      ...
      <nav
        aria-label="Primary"
        className="fixed inset-x-0 bottom-0 z-40 border-t-[1.5px] border-emerald-950/12 bg-[color-mix(in_srgb,var(--surface)_90%,var(--kraft))]/95 shadow-[0_-8px_24px_-18px_rgba(27,48,34,0.35)] backdrop-blur-md pb-[max(0.75rem,env(safe-area-inset-bottom,0px))]"
      >
